    ...
    <div className="flex flex-col gap-6 w-full max-w-md mx-auto">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <button 
          ...
          className="bg-slate-900/60 p-3 rounded-2xl border border-white/5 flex flex-col items-center group transition-colors hover:bg-slate-800"
        >
      ...
      <div className="flex gap-4 h-16 sm:h-20">
        <button
          ...
          className={`
            flex-[2] rounded-2xl font-black text-2xl sm:text-3xl shadow-2xl transition-all active:scale-95
            flex items-center justify-center gap-3 tracking-tighter
            ${(isAutoPlaying || isFinished || isRolling) 
              ? 'bg-slate-800 text-slate-600 cursor-not-allowed border border-slate-700 opacity-50' 
              : 'bg-gradient-to-br from-indigo-500 via-blue-600 to-indigo-700 hover:from-indigo-400 hover:to-indigo-600 text-white shadow-indigo-500/40 border-t border-white/20'
            }
          `}
        >
        ...
        <button
          ...
          className={`
            flex-1 rounded-2xl font-bold text-sm shadow-xl transition-all active:scale-95
            flex flex-col items-center justify-center gap-1
            ${isAutoPlaying 
              ? 'bg-amber-500 text-amber-950 border-t border-white/30 animate-pulse' 
