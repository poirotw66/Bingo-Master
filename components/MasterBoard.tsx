                ...
                return (
                  <div 
                    ...
                    className={`
                      ...
                      h-7 sm:h-12 rounded-md sm:rounded-xl font-bold text-[10px] sm:text-lg transition-colors duration-200
                      ${isDrawn 
                        ? `${col.bg} text-white shadow-[0_0_20px_rgba(0,0,0,0.3)] z-10 border-t border-white/20` 
                        : 'bg-slate-800/50 text-slate-600 border border-white/10'
                      }
                    `}
                  >
                    {num}
